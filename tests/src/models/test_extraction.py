...
class TestExtractTextFromPdf(unittest.TestCase):
    ...
    def test_extract_text_from_pdf(
        ...
        # Assert that the convert_from_path function was called with the
        # correct arguments
        mock_convert_from_path.assert_called_once_with('path/to/pdf')

        # Assert that the image.save function was called with the correct
        # arguments
        mock_open.assert_called_once_with('src/data/output_image_1.png')

        # Assert that the image_to_string function was called with the correct
        # arguments
